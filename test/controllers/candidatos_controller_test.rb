...
class CandidatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidato" do
    assert_difference('Candidato.count') do
      post candidatos_url, params: { candidato: { contratado: @candidato.contratado, observacao: @candidato.observacao, usuario: @candidato.usuario, vaga: @candidato.vaga } }
    end
  ...
  test "should update candidato" do
    patch candidato_url(@candidato), params: { candidato: { contratado: @candidato.contratado, observacao: @candidato.observacao, usuario: @candidato.usuario, vaga: @candidato.vaga } }
